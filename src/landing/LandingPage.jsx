...
const LandingPage = () => {
  ...
  const allFeatures = [
    t('landingAllFeature1'), t('landingAllFeature2'), t('landingAllFeature3'),
    t('landingAllFeature4'), t('landingAllFeature5'), t('landingAllFeature6'),
    t('landingAllFeature7'), t('landingAllFeature8'), t('landingAllFeature9'),
      ...
      <section style={{
        ...
        <div style={{
          ...
          <p style={{ color: '#94a3b8', lineHeight: 1.8, fontSize: 16, maxWidth: 700, margin: '0 auto' }}>
            {t('landingWhatIsDesc1')}<strong style={{ color: '#00f5a0' }}>{t('landingWhatIsHighlight')}</strong>{t('landingWhatIsDesc2')}
            <br /><br />
      ...
      <section style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24 }}>
          <div style={{
            ...
            <h3 style={{ color: '#00f5a0', fontSize: 18, fontWeight: 700, marginBottom: 16 }}>{t('landingIncluded')}</h3>
            {[1, 2, 3, 4, 5, 6, 7].map((i) => (
              <div key={i} style={{ padding: '6px 0', fontSize: 14, color: '#cbd5e1', display: 'flex', gap: 8 }}>
          ...
          <div style={{
            ...
            <h3 style={{ color: '#ff6b6b', fontSize: 18, fontWeight: 700, marginBottom: 16 }}>{t('landingNotIncluded')}</h3>
            {[1, 2, 3, 4, 5, 6].map((i) => (
              <div key={i} style={{ padding: '6px 0', fontSize: 14, color: '#94a3b8', display: 'flex', gap: 8 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <div style={{
            ...
            <button onClick={() => setAnnual(true)} style={{
              ...
              {t('landingAnnual')} <span style={{ fontSize: 12, color: '#00f5a0', marginLeft: 4 }}>{t('landingAnnualDiscount')}</span>
            </button>
          </div>
        </div>
